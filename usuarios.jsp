...
<body>
    ...
    String sql = "SELECT id_usuario, endereco_id, nome, sobrenome, email, telefone FROM usuarios ";
    ...
    out.print("<li class='sel'><a href='usuarios.jsp'>Usuários</a></li>");
    ...
    while( dados.next() ) 
    {
        out.print("<tr>");
            ...
            out.print("<td>");
                out.print(dados.getString("endereco_id"));
            out.print("</td>");
